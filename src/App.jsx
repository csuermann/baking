        ...
        <div className="flex items-center gap-1">
          {onRecipePage && (
            <Link
              ...
              className="mr-1 p-1.5 -ml-1.5 rounded-lg text-stone-500 hover:text-amber-400 transition-colors"
            >
          ...
          <Link to="/" className="text-stone-200 font-semibold text-lg tracking-tight">
            Baking Assistant
          </Link>
        </div>
      </div>
