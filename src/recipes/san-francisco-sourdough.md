...
ingredients:
  ...
  - name: "Spelt flour 630"
    percent: 7.258
  - name: "Firm wheat starter (TA 150)"
    percent: 3.226
  - group: "Tangzhong"
  - name: "Water"
    percent: 16.129
...
A high-hydration spelt loaf built in three stages: a levain, a tangzhong (scalded paste that boosts moisture retention), and an autolyse, all brought together in the final dough. The tangzhong is the key to keeping spelt's open crumb without sacrificing structure.
...
1. **30 min** — Wet your hand, grab one side of the dough, stretch it up and fold it over to the opposite side. Rotate 90° and repeat 4 times around the dough — that's one set.
2. **60 min** — Repeat.
3. **90 min** — Repeat.
